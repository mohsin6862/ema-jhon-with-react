                ...
                <div className="card card-compact w-full bg-base-100 shadow-xl relative">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-end    ">
                            <button onClick={ ()=> addToCartBtn(props.product)} className="btn btn-primary w-full ">Add To Cart  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
